...
-   Variables contained in both **main and validation data**:
    ...
    -   **fq**cal: Daily total caloric intake in grams obtained from questionnaire
    -   **fq**calinc: Daily total caloric intake in 10g obtained from questionnaire
    -   **fq**tfat: Daily total fat intake in kilo calories obtained from questionnaire
    -   **fq**tfatinc: Daily total fat intake in 800kcal obtained from questionnaire
    -   **fq**alc: Daily alcohol intake in grams obtained from questionnaire
    -   **fq**alcinc: Daily alcohol intake in 12g obtained from questionnaire
    -   age: Age in years
...
-   Contained in **validation data**:
    ...
    -   **dr**cal: accurate measure of daily caloric intake in grams
    -   **dr**calinc: accurate measure of daily caloric intake in 10g
    -   **dr**tfat: accurate measure of daily fat intake in kilo calories
    -   **dr**tfatinc: accurate measure of daily fat intake in 800kcal
    -   **dr**alc: accurate measure of daily alcohol intake in grams
    -   **dr**alcinc: accurate measure of daily alcohol intake in 12g
